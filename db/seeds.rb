...
User.create! :id => 2, :email => "creator@hotmail.it", :password => "12345678", :password_confirmation => "12345678", :role => "creator"
User.create! :id => 3, :email => "player@gmail.it", :password => "12345678", :password_confirmation => "12345678"
User.create! :id => 4, :email => "david@gmail.it", :password => "12345678", :password_confirmation => "12345678"
User.create! :id => 5, :email => "eleonor@gmail.it", :password => "12345678", :password_confirmation => "12345678"
...
Challenge.create([  {id: 1, nome: "How to start", testo: "In questa serie di sfide, chiamate challenge, verranno introdotti alcuni concetti fondamentali riguardo alle competizioni Capture The Flag (CTF), in particolare del formato jeopardy. In ogni challenge ti verrà richiesto di trovare un''informazione segreta chiamata flag, sfruttando le vulnerabilità presenti all''interno della sfida. Trovando ed inviando la flag alla piattaforma otterrai dei punti in base alla difficoltà della sfida che ti farà salire in classifica. \nPer questa primissima challenge invia questa flag nel campo qua sotto: \nflag{My_f1R57_54Ni7Y_ch3Ck}", flag: "flag{My_f1R57_54Ni7Y_ch3Ck}", category: "Intro", hint: "Scrivi flag{My_f1R57_54Ni7Y_ch3Ck}", score: 100, user_id: 1}, 
                    ...
                    {id: 6, nome: "Password Cracker", testo: "Puoi crackare la password? Scarica il password checker qui e avrai bisogno della flag cifrata nella stessa directory", flag: "{545h_r1ng1ng_fa343060}", category: "Reverse Engineering", hint: "Controlla la password per la flag", score: 100, user_id: 1},  
                    {id: 7, nome: "Python reverse", testo: "Il file è stato cifrato con questo  file, riuscirai a defifrarlo?", flag: "flag{but_1_th0ught_Dlog_wa5_h4rd}", category: "Reverse Engineering", hint: "La chiave di cifratura va tra 0 e 255, ma ricorda che la flag ha sempre lo stesso formato ;)", score: 200, user_id: 1},  
...
UserChallenge.create! :id => 6, :flag_timestamp => "2022/07/14 15:05:02", :user_id => 3, :challenge_id => 8
